...
class MyGroupsViewHolder(
    ...
    fun bind(group: MyGroupsItem, onButtonClicked: (groupId: String) -> Unit) {
//        (view.findViewById(R.id.avatarImage) as ImageView).drawable =
        ...
        (view.findViewById(R.id.groupCardView) as MaterialCardView).setOnClickListener { onButtonClicked(group.id) }
    }
